...
namespace ghost_ros
{
  ...
  SentryEstimatorNode::SentryEstimatorNode() : Node("sentry_estimator_node")
  {
    ...
    //     "/v5/sensor_update",
    //     10,
    //     std::bind(&SentryEstimatorNode::EncoderCallback, this, _1));
  ...
  void SentryEstimatorNode::LoadROSParams()
  {
    ...
    declare_parameter("particle_filter.num_particles", 1);
  ...
  void SentryEstimatorNode::LaserCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
  {
    ...
    // fill in to update robot pose
    // particle_filter_.GetLocation
  ...
  // void SentryEstimatorNode::EncoderCallback(const ghost_msgs::msg::V5SensorUpdate::SharedPtr msg)
  // {
  ...
  void SentryEstimatorNode::OdomCallback(const nav_msgs::msg::Odometry::SharedPtr msg)
  {
    ...
    odom_loc_(msg->pose.pose.position.x, msg->pose.pose.position.y);
    odom_angle_ = 2*acos(msg->pose.pose.orientation.x);
  ...
  // void SentryEstimatorNode::CalculateOdometry(const ghost_msgs::msg::V5SensorUpdate::SharedPtr msg){
  ...
  // void SentryEstimatorNode::PublishGhostRobotState(const ghost_msgs::msg::V5SensorUpdate::SharedPtr sensor_update_msg){
  ...
  void SentryEstimatorNode::PublishGhostRobotState(const nav_msgs::msg::Odometry::SharedPtr odom_update_msg){
    // Initialize robot state msg
    auto robot_state_msg = ghost_msgs::msg::GhostRobotState{};
    robot_state_msg.header.stamp = odom_update_msg->header.stamp;
    robot_state_msg.header.frame_id = "base_link";
    ...
    // Velocity estimate (from odometry)
    robot_state_msg.x_vel = odom_update_msg->twist.twist.linear.x;
    robot_state_msg.y_vel = odom_update_msg->twist.twist.linear.y;
    robot_state_msg.theta_vel = odom_update_msg->twist.twist.angular.z;
    // just want roation about z-axis so get that only; shouldn't be rotating about another axis
  ...
  void SentryEstimatorNode::DrawParticles(geometry_msgs::msg::PoseArray &viz_msg)
  {
  ...
  void SentryEstimatorNode::PublishWorldTransform()
  {
